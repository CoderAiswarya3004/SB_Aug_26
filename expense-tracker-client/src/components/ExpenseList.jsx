        ...
        <tbody>
            ...
            expenses.map((exp,idx)=>(
             ...
             <td className='px-4 py-3 '>
                ...
                <button className='bg-yellow-400 hover:bg-yellow-500 text-white font-semibold rounded-lg px-3 py-1.5 transition-colors text-xs'>Edit</button>
                <button className='bg-red-400 hover:bg-red-500 text-white font-semibold rounded-lg px-3 py-1.5 transition-colors text-xs'>Delete</button>
                </div>
             </td>
